...
- Merge canonical messages, command cards, and consequential workstation actions into one arrival-ordered chronology with stable type-qualified keys. After restart, causally anchor durable proposal/approval/queued milestones after their originating controller turn and before later chat.
...
- Never describe a controller proposal as acknowledged execution. Only an Orchestrator acknowledgement may show a task, launch, permission, review, or accepted-state mutation as accepted.
