...
- While an active Wayfinder gate is pending, canonical Mission Draft mutation, Ad Hoc Delegation proposal/approval, and all production launch paths (Workstation, CLI, and TUI) reject before mutation. Conversation, read-only inspection, bounded research, Grilling, and throwaway prototypes continue through their normal command/controller boundaries.
